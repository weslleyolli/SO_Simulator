    ...
    while True:
        ...
        if choice == '1':
            ...
            if strategy_choice == '1':
                ...
                print(f"{blue}Estratégia First Fit selecionada.")
            elif strategy_choice == '2':
                memory_manager.set_strategy(Strategy.BEST_FIT)
                print(f"{blue}Estratégia Best Fit selecionada.")
            elif strategy_choice == '3':
                memory_manager.set_strategy(Strategy.WORST_FIT)
                print(f"{blue}Estratégia Worst Fit selecionada.")
            else:
                print(f"{red}Opção inválida. Por favor, escolha 1, 2 ou 3.")
            ...
            if success:
                print(
                    f"{blue}Processo criado com ID: {process.get_id()},  tamanho de memória: {process.get_size_in_memory()} ")
            else:
                print(f"{red}Erro ao criar processo.")
            ...
            if success:
                print(f"{blue}Processo com ID: {process_id} deletado.")
            else:
                print(f"{red}Processo com ID: {process_id} não encontrado.")
            ...
            print(f"{red}Opção inválida. Por favor, escolha entre 1, 2, 3 ou 4.")
